...
#' 2004 to 2014. Some missing values (\code{NA}) means that in some periods there is no agriculture activity.
#' 
...
#'   \item{month}{Factor with 12 levels. In case of 2004, it just considered from August to December (mid-seasson).}
